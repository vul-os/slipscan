...
Thanks for helping build self-hosted, decentralized personal finance. SlipScan is dual-licensed, and contributions are accepted under both: [MIT](LICENSE-MIT) OR [Apache-2.0](LICENSE-APACHE), at the user's option.
