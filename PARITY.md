...
ledger a trade actually reaches. The one path that still bypasses it: a **standalone** invoice
(issued with no linked sales order) never posts revenue at all, only its payments do — see the
Invoicing row.
