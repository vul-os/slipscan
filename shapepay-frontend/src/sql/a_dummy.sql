...
INSERT INTO payment_groups (id, external_reference_id, total_amount, status, customer_id, created_at)
SELECT id, external_reference_id, total_amount, status, customer_id, created_at
