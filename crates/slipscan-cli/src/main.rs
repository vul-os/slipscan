...
use slipscan_core::domain::{
    ...
    NewProductCategory, NewProductVariant, NewPurchaseOrder, NewPurchaseOrderItem,
    NewRecurringSchedule, NewRecurringScheduleItem, NewSalesOrder, NewSalesOrderItem,
    ...
    RecurringFrequency, RecurringScheduleItemPatch, RecurringScheduleKind, RecurringSchedulePatch,
