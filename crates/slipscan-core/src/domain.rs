...
mod tests {
    ...
    fn every_nullable_patch_field_uses_the_double_option_deserializer() {
        ...
        assert_eq!(
            checked, 32,
            "expected 32 nullable patch fields (23 pre-existing, including \
             AssetPatch from migration 0016, + 9 added by RecurringSchedulePatch in \
             migration 0017); if this moved, the count and the fields above both \
             need looking at rather than the number bumping"
        );
    }
