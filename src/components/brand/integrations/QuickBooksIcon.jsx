 ...
 * Brand colour: #2CA01C (QuickBooks Green)
 * SVG path sourced from simple-icons (MIT licence).
 * The path encodes the QB "qb" mark inside a circle.
 */
export default function QuickBooksIcon({ className }) {
  return (
    <svg
