...
--      engineers.
--
-- Note: REVOKE UPDATE/DELETE requires knowing the exact app role name,
-- which varies between environments. Use the RULE approach instead for
-- portability. In a multi-role environment, additionally REVOKE UPDATE,
-- DELETE ON audit_log FROM <your_app_role>.
