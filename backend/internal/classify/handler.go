...
// CorrectionsHandler exposes the P1-03 HTTP endpoints.
...
// NewCorrectionsHandler creates a CorrectionsHandler backed by the given store.
func NewCorrectionsHandler(store *CorrectionsStore) *CorrectionsHandler {
	return &CorrectionsHandler{store: store}
}
...
func (h *CorrectionsHandler) PatchClassification(w http.ResponseWriter, r *http.Request) {
